...
class GymsControllerTest < ActionController::TestCase
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post :create, gym: { address: @gym.address, name: @gym.name, phone: @gym.phone, website: @gym.website }
    end
  ...
  test "should update gym" do
    patch :update, id: @gym, gym: { address: @gym.address, name: @gym.name, phone: @gym.phone, website: @gym.website }
    assert_redirected_to gym_path(assigns(:gym))
  end
